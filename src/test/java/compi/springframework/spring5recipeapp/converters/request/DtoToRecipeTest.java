...
public class DtoToRecipeTest {
    ...
    DtoToRecipe converter;

    @Before
    public void setUp() {
        converter = new DtoToRecipe(new DtoToNotes(), new DtoToCategory(),
                new DtoToIngredient(new DtoToUnitOfMeasure()));
    }
    ...
    public void convert() throws Exception {
        //given
        RecipeDTO recipeCommand = new RecipeDTO();
